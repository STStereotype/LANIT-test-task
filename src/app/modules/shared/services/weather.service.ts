...
export class WeatherService {
    ...
    getWeather(city: string): Observable<{ city: string, weather: Weather }> {
        ...
        //     });
        // return of({ city, weather: new Weather(Math.round(-5), 200) });
        // return of({ city, weather: new Weather(Math.round(-5), 300) });
        return of({ city, weather: new Weather(Math.round(20), 500) });
        // return of({ city, weather: new Weather(Math.round(-5), 600) });
        // return of({ city, weather: new Weather(Math.round(-5), 731) });
        // return of({ city, weather: new Weather(Math.round(20), 802) });
    }
